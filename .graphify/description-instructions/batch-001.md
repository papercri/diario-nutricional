...
- "commit:repo:github.com/papercri/diario-nutricional@c213fec10580e7d8eb2b248c19d9155b9399092e": "c213fec style: restyling completo con paleta food-inspired y tipografía con car…" | kind=Commit | source=git | neighbors=[88b4be1 feat: mejorar UI/UX con respons…, backend, dev, master, recetas, stage] | lang=es
...
- "composables_useauth": "useAuth.ts" | kind=code-symbol | source=src/composables/useAuth.ts:L1 | neighbors=[124ec25 feat(auth): implement Supabase …, 3a3bb2c feat(ui): saved cards with alle…, 443eb59 feat(profile): add tabbed inter…, 4fa3438 feat(dashboard): add tabbed int…, authResolved, clearAllLocalStorage()] | lang=en
- "stores_foodstore": "foodStore.ts" | kind=code-symbol | source=src/stores/foodStore.ts:L1 | neighbors=[067eeb3 refactor(imports): migrate rela…, 124ec25 feat(auth): implement Supabase …, 23e569a Merge pull request #14 from pap…, 3a3bb2c feat(ui): saved cards with alle…, 443eb59 feat(profile): add tabbed inter…, 4fa3438 feat(dashboard): add tabbed int…] | lang=en
- "types_user": "user.ts" | kind=code-symbol | source=src/types/user.ts:L1 | neighbors=[124ec25 feat(auth): implement Supabase …, 27955a0 Merge pull request #12 from pap…, 81209a9 first commit, b47c800 feat(profile): footer sticky, p…, food.ts, recipe.ts] | lang=en
...
- "commit:repo:github.com/papercri/diario-nutricional@443eb5934899bf3f5ab0ae280fc38e3bc8612837": "443eb59 feat(profile): add tabbed interface with Mi día, Mis platos, Mis receta…" | kind=Commit | source=git | neighbors=[1df5892 fix(ui): replace custom add-to-…, backend, dev, 70b8f69 feat(profile): tabbed interface…, useAuth.ts, foodStore.ts] | lang=en
